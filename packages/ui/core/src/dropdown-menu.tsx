/**
 * comwit-ui — dropdown-menu. Radix Primitives 구현을 그대로 이식한 자체 엔진 (외부 @radix-ui 의존성 없음).
 */
...
import * as MenuPrimitive from './internal/menu'
import { createMenuScope } from './internal/menu'
