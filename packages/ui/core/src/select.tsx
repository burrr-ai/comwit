/**
 * comwit-ui — select. Radix Primitives 구현을 그대로 이식한 자체 엔진 (외부 Radix 패키지 의존성 없음).
 */
import * as React from 'react'
import * as ReactDOM from 'react-dom'
import { clamp } from './internal/number'
import { composeEventHandlers } from './internal/compose-event-handlers'
import { createCollection } from './internal/collection'
...
import { DismissableLayer } from './internal/dismissable-layer'
import { useFocusGuards } from './internal/focus-guards'
import { FocusScope } from './internal/focus-scope'
import { useId } from './internal/id'
import * as PopperPrimitive from './internal/popper'
import { createPopperScope } from './internal/popper'
import { Portal as PortalPrimitive } from './internal/portal'
import { Presence } from './internal/presence'
import { Primitive } from './internal/primitive'
import { createSlot } from './slot'
import { useCallbackRef } from './internal/use-callback-ref'
import { useControllableState } from './internal/use-controllable-state'
import { useLayoutEffect } from './internal/use-layout-effect'
import { usePrevious } from './internal/use-previous'
import { VISUALLY_HIDDEN_STYLES } from './internal/visually-hidden'
...
type SelectControlProps =
  ControlledClearableSelectProps | ControlledUnclearableSelectProps | UncontrolledSelectProps
