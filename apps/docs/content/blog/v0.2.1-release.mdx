...
### `query().query()` no longer throws on second call ([#35](https://github.com/burrr-ai/comwit/issues/35))
...
**Fix:** The proxy engine now shallow-clones any frozen object before wrapping it, so frozen snapshots from the cache are never mutated directly. ([PR #36](https://github.com/burrr-ai/comwit/pull/36))
...
[GitHub Release](https://github.com/burrr-ai/comwit/releases/tag/v0.2.1) | [npm](https://www.npmjs.com/package/comwit/v/0.2.1)
