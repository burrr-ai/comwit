...
Add the [provider](/state/docs/guide/quickstart) once above the route.
...
Do not initialize state by calling an action in a render body. Deprecated [`silent()`](/state/docs/api/silent)
