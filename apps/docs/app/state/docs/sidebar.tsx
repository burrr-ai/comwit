...
function hrefFor(doc: DocMeta) {
  return doc.slug === '' || doc.slug === 'index' ? '/state/docs' : `/state/docs/${doc.slug}`
}
  ...
  return (
    <div className="docs-sidebar-content">
      <div className="sidebar-heading">
        ...
        <h2>
          Comwit State <small className="state-version">{stateVersion}</small>
        </h2>
      </div>
      ...
      <a className="sidebar-agent" href="/state/llms.txt">
