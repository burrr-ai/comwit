...
See the [URL state reference](https://github.com/meursyphus/comwit/blob/latest/apps/docs/content/docs/api/router.mdx) for parsing, defaults,
...
This repository uses **Yarn Classic (1.22.22)** workspaces.
...
Run these commands separately as needed:

| Command                                  | Purpose                           |
| ---------------------------------------- | --------------------------------- |
| `yarn workspace @comwit/state dev`       | Watch and rebuild the library     |
| `yarn dev:playground`                    | Start the playground on port 3001 |
| `yarn workspace @comwit/state test`      | Run the library tests             |
| `yarn workspace @comwit/state typecheck` | Check library and API test types  |

| Directory                                            | Contents                                  |
| ---------------------------------------------------- | ----------------------------------------- |
| [`packages/comwit`](./packages/comwit)               | `@comwit/state` source and tests          |
| [`packages/comwit-compat`](./packages/comwit-compat) | Deprecated `comwit` compatibility package |
| [`apps/docs`](./apps/docs)                           | Documentation website                     |
| [`apps/playground`](./apps/playground)               | Example and development playground        |

Found a bug or have an idea? [Open an issue](https://github.com/meursyphus/comwit/issues).
